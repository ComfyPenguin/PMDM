import 'package:healthys_drift_example/domain/entities/producte_entity.dart';

class EntrantEntity extends ProducteEntity {
  ...
  factory EntrantEntity.fromJson(Map<String, dynamic> json, String urlBase) {
