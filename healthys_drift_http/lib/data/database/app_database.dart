...
import 'package:healthys_drift_http/data/database/dao/dieta_dao.dart';
...
class AppDatabase extends _$AppDatabase {
  ...
  // Accessors als DAOs
  late final EntrantDao entrantDao = EntrantDao(this);
  late final DietaDao dietaDao = DietaDao(this);
