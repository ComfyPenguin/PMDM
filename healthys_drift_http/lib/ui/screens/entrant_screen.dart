...
import 'package:healthys_drift_http/ui/screens/entrants/new_entrant_dialog.dart';
...
class EntrantsScreen extends StatefulWidget {
  ...
  const EntrantsScreen({super.key, required this.repository}); // Modificat!
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                isThreeLine:
                    e.description != null && e.description!.trim().isNotEmpty,
                trailing: IconButton(
