...
class EntrantDetall extends StatefulWidget {
  ...
  @override
  State<EntrantDetall> createState() => _EntrantDetallState();
}

class _EntrantDetallState extends State<EntrantDetall> {
  ...
  Widget build(BuildContext context) {
    final entrant =
        widget.entrant; // Agafem l'entrant del widget associat a l'estat
    ...
    return Stack(
      children: [
        ...
        SizedBox(
          ...
          child: Image.network(
            // Carreguem la imatge de l'entrant
            entrant.img ?? "",
            fit: BoxFit.cover,
                ...
                children: [
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: [
                        Text(
                          // Nom de l'entrant. Observeu que partim dels
                        ...
                        // per a la pizzeria)
                        LlistaAlergens(alergens: entrant.allergens),
                        ...
                        Row(
                          children: [
                            ...
                            // Preu formatat
                            Text(
                              _formatPrice(entrant.price ?? 0.0),
                        ...
                        _InfoRow(label: "Categoría", value: "${entrant.tipus}"),
                        _InfoRow(
                          ...
                          value: entrant.dietType!.isNotEmpty
                              ? entrant.dietType.toString()
                              : "-",
                        ),

                        _InfoRow(
                          label: "Calories",
                          value: "${entrant.calories}Kcal",
                        ),
                        ...
                        child: _quantitat == 0
                            ? SizedBox(
                                ...
                                child: FilledButton.icon(
                                  ...
                                  label: Text("Afegir · ${entrant.price}€"),
                                ),
                              )
                            : _QuantityBar(
