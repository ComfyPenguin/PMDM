...
import 'package:healthys_app/presentation/screens/principals/principal_detall.dart';

class GridPrincipals extends StatelessWidget {
  final List<Principal> llistaPrincipals;
  const GridPrincipals(this.llistaPrincipals, {super.key});
      ...
      builder: (context, constraints) {
        ...
        return GridView.builder(
          ...
          itemBuilder: (ctx, i) {
            ...
            return PrincipalCard(principal: llistaPrincipals[i]);
          },
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (BuildContext context) {
                return PrincipalDetall(principal: principal);
              },
            ),
          );
        },
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                // Text amb el preu
                Text(
                  "${principal.price?.toStringAsFixed(2)}€",
            ...
            if (principal.additionalInfo != null &&
                principal.additionalInfo!.isNotEmpty)
              Padding(
