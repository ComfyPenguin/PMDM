...
import 'package:healthys_app/presentation/screens/begudes/beguda_detall.dart';
  
class GridBegudes extends StatelessWidget {
  final List<Beguda> llistaBegudes;
  const GridBegudes(this.llistaBegudes, {super.key});
      ...
      builder: (context, constraints) {
        ...
        return GridView.builder(
          ...
          itemBuilder: (ctx, i) {
            ...
            return BegudaCard(beguda: llistaBegudes[i]);
          },
...
class BegudaCard extends StatelessWidget {
  final Beguda beguda;

  const BegudaCard({super.key, required this.beguda});
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (BuildContext context) {
                return BegudaDetall(beguda: beguda);
              },
            ),
          );
        },
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                // Text amb el preu
                Text(
                  "${beguda.price?.toStringAsFixed(2)}€",
            ...
            if (beguda.additionalInfo != null &&
                beguda.additionalInfo!.isNotEmpty)
              Padding(
