...
class BegudaDetall extends StatefulWidget {
  final Beguda beguda;
  final int quantitat;

  const BegudaDetall({
    super.key,
    required this.beguda,
    this.quantitat = 0, // Proporcionem la quantitat inicial
  });

  @override
  State<BegudaDetall> createState() => _BegudaDetallState();
}

class _BegudaDetallState extends State<BegudaDetall> {
  ...
  Widget build(BuildContext context) {
    final beguda =
        widget.beguda; // Agafem la beguda del widget associat a l'estat
    ...
    return Stack(
      children: [
        ...
        SizedBox(
          ...
          child: Image.network(
            // Carreguem la imatge de la beguda
            beguda.img ?? "",
            fit: BoxFit.cover,
                  ...
                  Expanded(
                    child: ListView(
                      ...
                      children: [
                        ...
                        // per a la pizzeria)
                        LlistaAlergens(alergens: beguda.allergens),
                        ...
                        _InfoRow(
                          label: "Categoría",
                          value: beguda.isAlcoholic == true
                              ? "Beguda Alcoholica"
                              : "Beguda Sense Alcohol",
                        ),
                        _InfoRow(
                          label: "Alcohol",
                        ...
                        child: _quantitat == 0
                            ? SizedBox(
                                ...
                                child: FilledButton.icon(
                                  ...
                                  label: Text("Afegir · ${beguda.price}€"),
                                ),
                              )
                            : _QuantityBar(
