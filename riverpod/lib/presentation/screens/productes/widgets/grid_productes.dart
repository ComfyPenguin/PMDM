...
import 'package:healthys_app/presentation/screens/productes/producte_detall.dart';

class GridProducts extends StatelessWidget {
  final List<Producte> llistaProductes;
  const GridProducts(this.llistaProductes, {super.key});

  // Funcions auxiliars per determinar propietats del grid i l'espaiat
      ...
      builder: (context, constraints) {
        ...
        return GridView.builder(
          ...
          itemBuilder: (ctx, i) {
            ...
            return ProducteCard(producte: llistaProductes[i]);
          },
...
class ProducteCard extends StatelessWidget {
  ...
  const ProducteCard({super.key, required this.producte});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: InkWell(
        ...
        onTap: () {
          // Navegar a detalls del producte
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (BuildContext context) {
                return ProducteDetall(producte: producte);
              },
            ),
          );
        },
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Nom del producte. Si se'n passa de dues línies,
            ...
            if (producte.additionalInfo != null &&
                producte.additionalInfo!.isNotEmpty)
              Padding(
